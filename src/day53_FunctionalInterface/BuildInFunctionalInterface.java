...
public class BuildInFunctionalInterface {
    public static void main(String[] args) {
        ...
        names.addAll(Arrays.asList("Level", "Anna", "Java", "Python", "racecar"));
      ...
      /*  for (Integer each : list2) {
           if(each %2 !=0){
               System.out.println(each + " is an odd number");
           }
        }
       ...
       */
        ...
        List<String> emplyees = new ArrayList<>();
        emplyees.addAll(Arrays.asList("Suhaib Muftah", "Layan Assim", "Maria Meek", "Krisitna Edman", "Amin Nassirof", "Nermin Mohammed"));
        for (String each : emplyees) {

        }
        emplyees.forEach(s -> System.out.println(s.charAt(0) + "." + s.charAt(s.lastIndexOf(" ") + 1)));
