...
public class MapPractice2 {
    public static void main(String[] args) {
        ...
        //4 display the names of the employees who are making less than 118k?
        for (Map.Entry<String, Integer> pair : map.entrySet()) {
        ...
        System.out.println("======================================================================================");
        //5 increase the salary of employee by 10K  if the current salary of the employee is less than 120000
