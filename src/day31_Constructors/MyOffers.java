...
public class MyOffers {
    public static void main(String[] args) {
     ...
     offer1.setInfo("VA","Amazon Inc.","SDET",110000,true,true,true,true);
        ...
        offer4.setInfo("TX","CapitalOnce", "Scrum Master", 115000, false,false,true,true);
        ...
        localOffers.removeIf(p->!(p.location.equals("VA")|| p.location.equals("CA"))); // removes the offers that are not from VA or CA
