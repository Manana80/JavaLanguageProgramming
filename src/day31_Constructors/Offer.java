...
public class Offer {
    ...
    public void setInfo (String location, String companyName, String jobTitle, double salary, boolean hasBenefit, boolean hasPTO, boolean isWHH, boolean isFullTime) {
        ...
        // this. will help us distinguish between a local variable and instance variable sharing the same name.
        // instance means we need a separte copy of the info for each object
    }
// this method helps us generate all the attributes of this class
